...
@section('title')
    ADN México | Creacion de Usuario
@endsection
	...
	<div class="card-block mb-3">
		<div class="container">
			<div class="card-title p-3 mb-3 card-header">
				<img src="{{asset('images/usuarios.png')}}" alt="" width="80" height="70" class=""><span class="h4 ml-3 font-weight-bold">Creacion de Usuario</span>
			</div>
